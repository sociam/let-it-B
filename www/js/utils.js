...
(function() {
	angular
		.module('bstripes').factory('utils',function() {
			...
			return {
				...
				profilePhotoStyle : function(url) {
					// console.info(' ----------------------------- profilephotostyle >> ', url);
			...
			return {
				...
				transclude:true,
				replace:true,
				template:'<span class="link" ui-sref="treatment({id:name})" ng-transclude></span>'
			};
